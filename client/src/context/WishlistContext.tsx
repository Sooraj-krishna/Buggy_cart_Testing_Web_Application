...
import { useCart } from '@/context/CartContext.tsx'; // Assuming CartContext is available and has useCart
 ...
 * This component consumes both WishlistContext and CartContext to demonstrate their usage.
...
export function WishlistDemoProducts() {
  ...
  const { addToCart } = useCart(); // Assuming addToCart takes product and quantity
